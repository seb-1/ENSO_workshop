...
basedir_regridded_CMIP6_LE=/glade/scratch/milinski/ESGF_downloads/SST_regridded
...
# run_0=1
# run_n=40 # p1 and scenario only go to 25, p2 hist goes to 40
# model=CanESM5
# experiment=historical
# varstring=ts
# suffix=i1p1f1
...
# idir=$basedir_MMLEA/cesm2_lens/lens_mergetime_regrid/${experiment}/SST/
...
#     ofile2=${outdir}/sst_mon_${model}_${experiment}_${init}_nino34.nc
#     cdo fldmean -sellonlatbox,-170,-120,-5,5 ${ifiles} ${ofile}
#     cp ${ofile} ${ofile2}
# done
...
# idir=$basedir_MMLEA/ipsl_cm6a_lens/Omon/tos
...
# # IPSL doesn't have members 11-13, but does have 14. We relabel this as member 11.
# rrr=14
# experiment=ssp370
# expid=r$(printf "%01d" $rrr)${suffix}
# expid_out=r11${suffix}
# datdir=${idir}
# ifiles=${datdir}/tos_mon_${model}_${experiment}_${expid}_g025.nc
